...
import acme.thermoregulator.EfficientThermoregulator;
...
public class AppConfiguration2 {
    @Bean
    Thermometer thermometer(){return new Thermometer();}
    @Bean
    Heater heater(){return new Heater();}
    @Bean
    Thermoregulator thermoregulator(){return new EfficientThermoregulator();}
    @Bean
    PowerSwitch powerswitch(){return new PowerSwitch();}
